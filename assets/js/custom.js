    ...
    * Counter JS
    ----------------------*/
	 NAY.Counter = function () {
	  ...
	  var $counter = $('.counter');
	  if(counter.length > 0) {  
	      loadScript(plugin_track + 'js/jquery.countTo.js', function() {
    ...
    * OwlSlider
    ...
    NAY.Gallery = function() {
    	if ($(".lightbox-gallery").exists() || $(".popup-youtube, .popup-vimeo, .popup-gmaps").exists()){
    		loadScript(plugin_track + 'js/jquery.magnific-popup.min.js', function() {
    ...
    * Masonry
    ...
    NAY.masonry = function () {
    	...
    	if ($(".portfolio-content").exists()){
    		loadScript(plugin_track + 'js/isotope.pkgd.min.js', function() {
    			if ($(".portfolio-content").exists()){
    ...
    NAY.particles = function() {
      if ($("#particles-box").exists()){
        loadScript(plugin_track + 'js/particles.min.js', function() {
        });
        loadScript(plugin_track + 'js/particles-app.js', function() {
        });
      }
    }
